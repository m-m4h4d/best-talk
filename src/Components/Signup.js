            ...
            <Container style={{ padding: '2rem' }} align='center'>
                <Box align='center' width='20rem'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <TextField required fullWidth margin='normal' id='firstName' label='First Name' size='small' style={{ background: '#E8EDF5', color: '#4A789C' }} />
                        <TextField required fullWidth margin='normal' id='lastName' label='Last Name' size='small' style={{ background: '#E8EDF5', color: '#4A789C' }} />
                        <TextField required fullWidth margin='normal' id='emailAddress' label='Email Address' type='email' size='small' style={{ background: '#E8EDF5', color: '#4A789C' }} />
                        ...
                        <TextField required fullWidth margin='normal' id='confirmPassword' label='Confirm Password' type='password' size='small' style={{ background: '#E8EDF5', color: '#4A789C' }} />
                        <Button type='submit' variant='contained' style={{ borderRadius: '12px', margin: '1rem', background: '#2196D4' }}>Continue</Button>
                    </form>
